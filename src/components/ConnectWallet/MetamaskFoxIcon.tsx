export function MetamaskFoxIcon() {
  return (
    <svg
    ...
    >
      <g strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.25">
        ...
        <g fill="#e27625" stroke="#e27625">
          <path d="M2.663 1l13.017 9.809-2.325-5.818zM28.23 23.534l-3.495 5.338 7.483 2.06 2.143-7.282zM1.273 23.65l2.13 7.282 7.47-2.06-3.481-5.339z"></path>
          <path d="M10.47 14.515L8.393 17.65l7.405.337-.247-7.97zM25.15 14.515l-5.157-4.587-.169 8.06 7.405-.337zM10.873 28.872l4.482-2.164-3.858-3.006zM20.266 26.708l4.469 2.164-.61-5.17z"></path>
        </g>
        <path
          fill="#d5bfb2"
          stroke="#d5bfb2"
